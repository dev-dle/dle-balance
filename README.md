...
2. Укаживе поля с доп полями для поиска.
   ...
   2. Приоритет поиска по доп полях: kinopoisk.ru, ImDb, World Art, по
      названию!
3. укажите куда будет вставлен эмбед
...
6. Доп. поле для вставки эмбеда - в данное доп. поле плагин будет писать
   ссылку на нужный материал.
